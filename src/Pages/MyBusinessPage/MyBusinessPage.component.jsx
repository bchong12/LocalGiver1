...
import "./MyBusinessPage.component.css";
        ...
        <div className="my-business-page">
          ...
          <div className="middle-of-business">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/G1Bl_cy0svM"
              frameBorder="0"
            ...
            <div className="deals">
              <div className="deal">
                <p className="deal-title">
                  Get Our Book On How to Make Specialty Coffees, Lattes, and
          ...
          <div className="story">
            ...
            <div className="top-of-story">
              <img
                className="us-img"
                src="https://pbs.twimg.com/media/C-g7lGgXkAIiDj1.jpg"
              />
            </div>
            <p className="story-text">
              At SMALL BUSINESS 1 we're more than just a coffee company. We
              ...
              Just SMALL BUSINESS 1 Coffee Roasters, we want to work with our
