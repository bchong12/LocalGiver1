...
import "./MyBusinessPage2.component.css";
import axios from "axios";

class MyBusinessPage2 extends React.Component {
  constructor() {
    super();
  }
      ...
      <>
        ...
        <div className="my-business-page">
          <div className="top-coffee">
            <h1>Small Business 2</h1>
            <p>Your local community resturant, serving fresh food since 1992</p>
          </div>
          <div className="middle-of-business">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/LceikKL7Vcc"
              frameBorder="0"
            ...
            <div className="deals">
              <div className="deal">
                <p className="deal-title">
                  Get Our Book On How to Make Specialty Tamales, Paninis, and
                  More Exactly How We Do It In-house!
                </p>
          ...
          <div className="story">
            ...
            <div className="top-of-story">
              <img
                className="us-img"
                src="https://s3-eu-west-1.amazonaws.com/wbm.thumbnail/dissolve/1200/695059.jpg"
              />
            </div>
            <p className="story-text">
              At SMALL BUSINESS 2 we're more than just a resturant company. We
              combine our mission to be a catalyst for love with a dedication to
              producing the finest food offerings through our franchises. We
              love the big wide world we live in and make helping its people a
              core aim of our business. The waft of excellent hand-roasted
              coffee is surely one of the world’s greatest aromas, but to us, it
              ...
              Just SMALL BUSINESS 2 Coffee Roasters, we want to work with our
...
export default MyBusinessPage2;
