...
import "./MyBusinessPage3.component.css";
import axios from "axios";

class MyBusinessPage3 extends React.Component {
  constructor() {
    super();
  }
      ...
      <>
        ...
        <div className="my-business-page">
          <div className="top-coffee">
            <h1>Small Business 3</h1>
            <p>
              Your local community clothing, serving fire clothes since 2001
            </p>
          </div>
          <div className="middle-of-business">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/RRv5udKGG68"
              frameBorder="0"
            ...
            <div className="deals">
              <div className="deal">
                <p className="deal-title">
                  Buy Our In-house magazine! Great For House Decoration or some
                  leisure time reading!
                </p>
                <p className="deal-price">$25</p>
                <button
                  onClick={() => {
                    axios.post(
                      "https://ancient-woodland-39807.herokuapp.com/api/cart/new",
                      { title: "Magazine", price: 25 }
                    );
                  }}
          ...
          <div className="story">
            ...
            <div className="top-of-story">
              <img
                className="us-img"
                src="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80"
              />
            </div>
            <p className="story-text">
              At SMALL BUSINESS 3 we're more than just a fashion company. We
              combine our mission to be a catalyst for love with a dedication to
              producing the finest clothes through our franchises. We love the
              big wide world we live in and make helping its people a core aim
              of our business. The waft of excellent hand-roasted coffee is
              surely one of the world’s greatest aromas, but to us, it
              represents more than just a job well done. It’s an opportunity to
              change the world we live in; to put people before profit; to give
              back to the community. Just SMALL BUSINESS 1 has been a finalist
              in the prestigious Roaster of the Year in 2014 and 2015. The
              business has grown since its inception seven years ago. Our
              franchises now offer great food to match our coffee. A cup of
              ...
              Just SMALL BUSINESS 3 Fashionistas, we want to work with our
...
export default MyBusinessPage3;
