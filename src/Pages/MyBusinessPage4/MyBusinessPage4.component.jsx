...
import "./MyBusinessPage4.component.css";
import axios from "axios";

class MyBusinessPage4 extends React.Component {
  constructor() {
    super();
  }
      ...
      <>
        ...
        <div className="my-business-page">
          <div className="top-coffee">
            <h1>Small Business 4</h1>
            <p>
              Your local community jewlery store, serving cool jewlery since
              1966
            </p>
          </div>
          <div className="middle-of-business">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/BaeQxFJT7_w"
              frameBorder="0"
            ...
            <div className="deals">
              <div className="deal">
                <p className="deal-title">
                  Get A Custom Made Jewlery Box! Perfect for holding Jewels!
                </p>
              ...
              <div className="deal">
                <p className="deal-title">
                  Get A Voucher for $100 a fraction of the price, redeemable
                  when we re-open!
                </p>
                <p className="deal-price">$90</p>
                <button
                  onClick={() => {
                    axios.post(
                      "https://ancient-woodland-39807.herokuapp.com/api/cart/new",
                      { title: "Voucher", price: 90 }
                    );
                  }}
                  className="deal-button"
                >
          ...
          <div className="story">
            ...
            <div className="top-of-story">
              <img
                className="us-img"
                src="https://images.unsplash.com/photo-1578632297758-3a6c6de14be8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80"
              />
            </div>
            <p className="story-text">
              At SMALL BUSINESS 4 we're more than just a jewlery company. We
              ...
              Just SMALL BUSINESS 4 jewlers, we want to work with our customers
              to “...be the change that you wish to see in the world.” We
              believe we can change the world, one bean at a time.
            </p>
          </div>
        </div>
      </>
...
export default MyBusinessPage4;
