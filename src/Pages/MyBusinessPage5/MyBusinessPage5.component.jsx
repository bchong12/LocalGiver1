...
import "./MyBusinessPage5.component.css";
import axios from "axios";

class MyBusinessPage5 extends React.Component {
  constructor() {
    super();
  }
      ...
      <>
        ...
        <div className="my-business-page">
          <div className="top-coffee">
            <h1>Small Business 5</h1>
            <p>Your local community paint shop, teaching painting since 2012</p>
          </div>
            ...
            <div className="deals">
              <div className="deal">
                <p className="deal-title">
                  Get Our Book On How to Paint! Be like Bob Ross!
                </p>
          ...
          <div className="story">
            ...
            <div className="top-of-story">
              <img
                className="us-img"
                src="https://images.unsplash.com/photo-1596495717664-15c0aa11458c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80"
              />
            </div>
            <p className="story-text">
              At SMALL BUSINESS 5 we're more than just a paint company. We
              ...
              Just SMALL BUSINESS 5 Paint, we want to work with our customers to
              “...be the change that you wish to see in the world.” We believe
              we can change the world, one bean at a time.
            </p>
          </div>
        </div>
      </>
...
export default MyBusinessPage5;
